...
- eb18dbb: Add the first Platform Shell design foundation for the web app with Manrope-based global tokens, five persisted UI moods, and the reviewed Claude Design handoff package.
...
- 7d39df4: Add Full Accounting external result intake and internal acceptance 1.4 with
  intake anchor, returned artifact registry, internal acceptance criteria,
  acceptance decision workspace, command center, closeout API, dashboard wiring,
...
- afae1ac: Add Full Accounting external execution tracking 1.3 with tracking anchor,
  status ledger, returned evidence validation workspace, observation resolution
  queue, command center, closeout API, dashboard wiring, conceptual model updates,
  and smoke coverage.
...
- 67d739d: Add Full Accounting signature and certification boundary 1.1 with boundary
  anchor, signatory registry, signature evidence pack, certification requirement
  workspace, legalization boundary packet, closeout API, dashboard wiring,
  conceptual model updates, and smoke coverage.
...
- 3996dc8: Add Full Accounting product design 0.6 with product design anchor, scope
  contract, responsibility matrix, artifact boundary registry, workflow control
  blueprint, closeout API, dashboard wiring, conceptual model updates, and smoke
  coverage.
...
- 12e2170: Add Full Accounting MVP Readiness 0.2 with readiness anchor, ledger persistence
  design, posting policy boundary, bank feed reconciliation readiness, trial
  balance statement readiness, closeout API, dashboard wiring, conceptual model
  updates, and smoke coverage.

## 0.107.49

### Patch Changes

- 104e787: Add Full Accounting Candidate 0.1 with candidate anchor, core ledger scope,
  bank reconciliation boundary, financial statements blueprint, legal books
  statutory boundary, closeout API, dashboard wiring, conceptual model updates,
  and smoke coverage.
...
- 7b7eaff: Add Accounting Advanced graduation and archive handoff check with handoff
  anchor, archive package, graduation signals, product scope decision, command
...
- 712404e: Add Accounting Advanced Formal Readiness 0.6 with policies and closing templates, external accountant portal shell, adjustment automation workbench, multi-period statement workspace, formal books signing boundary packet, certified bank reconciliation readiness closeout, dashboard wiring, conceptual model updates, and smoke coverage.

## 0.107.36

### Patch Changes

- f2238a2: Add Accounting Advanced Product Graduation 0.5 with pilot learning registry, accountant acceptance criteria, graduation matrix, formal books and certified bank-feed boundary blueprints, graduation closeout API, dashboard wiring, conceptual model updates, and smoke coverage.
...
- 87a8859: Add Accounting Advanced MVP Readiness 0.2 with scope registry, accountant-owned
  scope decision record, minimum ledger closeout design, certified bank evidence
  boundary, audit trail readiness packet, closeout API, dashboard wiring,
  conceptual model updates, and smoke coverage.
...
- 5740d53: Add Psychology Clinics records 3.0 with records hardening, clinical evidence registry, session note review loop, risk and safety review, privacy consent controls, records closeout, API endpoints, web client contracts, and console surfaces.
...
- 22809c3: Add Ecuador tax declaration filing operations for obligation workspaces, form box evidence binders, annex readiness 2.0, accountant review room 3.0, artifact export 2.0, and declaration closeout 3.0.
...
- 6e78565: Add Tax Compliance party hardening workspaces that consume Parties 2.0 evidence for declaration impact, assisted corrections, accountant escalation, and closeout v4.
...
- fe26cb0: Add catch-up release notes for the ecommerce operator-assisted and transactional operations work completed across recent PRs, including post-sale resolution packets, invoice handoff execution, customer and fiscal profile updates, fulfillment availability, inventory reservation, payment reconciliation, and returns, refunds, and cancellation workspaces.

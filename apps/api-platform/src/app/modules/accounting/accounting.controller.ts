...
import {
  ...
  FullAccountingFormalRecordCloseoutCommandCenterResponseDto,
  FullAccountingProfessionalCloseoutAttestationBoundaryResponseDto,
  ...
  toFullAccountingFormalArtifactDraftingAnchorResponseDto,
  toFullAccountingFormalLedgerDraftPackResponseDto,
  toFullAccountingPostingApprovalDraftPackResponseDto,
  ...
  toFullAccountingFormalApprovalWorkflowAnchorResponseDto,
  toFullAccountingApprovalAuthorityMatrixResponseDto,
  toFullAccountingFormalApprovalEvidencePackResponseDto,
  ...
  toFullAccountingExternalExecutionStatusLedgerResponseDto,
  toFullAccountingExternalExecutionTrackingAnchorResponseDto,
  toFullAccountingExternalExecutionTrackingCloseoutResponseDto,
  toFullAccountingExternalExecutionTrackingCommandCenterResponseDto,
  toFullAccountingExternalObservationResolutionQueueResponseDto,
  ...
  toFullAccountingFormalRecordCloseoutCommandCenterResponseDto,
  toFullAccountingProfessionalCloseoutAttestationBoundaryResponseDto,
  ...
  toFullAccountingInternalAcceptanceCommandCenterResponseDto,
...
export class AccountingController {
  ...
  @Get(':slug/full-accounting-formal-artifact-drafting/anchor')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalArtifactDraftingAnchor(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingFormalArtifactDraftingAnchorResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingFormalArtifactDraftingAnchorUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingFormalArtifactDraftingAnchorResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-formal-artifact-drafting/ledger-draft-pack')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalLedgerDraftPack(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingFormalLedgerDraftPackResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingFormalLedgerDraftPackUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingFormalLedgerDraftPackResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(
    ':slug/full-accounting-formal-artifact-drafting/posting-approval-draft-pack',
  )
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingPostingApprovalDraftPack(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingPostingApprovalDraftPackResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingPostingApprovalDraftPackUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingPostingApprovalDraftPackResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-formal-artifact-drafting/bank-evidence-draft-pack')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingBankReconciliationEvidenceDraftPack(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingBankReconciliationEvidenceDraftPackResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingBankReconciliationEvidenceDraftPackUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingBankReconciliationEvidenceDraftPackResponseDto(
        view,
      );
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
  ...
  @Get(':slug/full-accounting-formal-artifact-drafting/statement-draft-pack')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingTrialBalanceFinancialStatementDraftPack(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingTrialBalanceFinancialStatementDraftPackResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingTrialBalanceFinancialStatementDraftPackUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingTrialBalanceFinancialStatementDraftPackResponseDto(
        view,
      );
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
  ...
  @Get(':slug/full-accounting-formal-artifact-drafting/closeout')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalArtifactDraftingCloseout(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingFormalArtifactDraftingCloseoutResponseDto> {
    try {
      const view =
        await this.requestTenantFullAccountingFormalArtifactDraftingCloseoutUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
  ...
  @Get(':slug/full-accounting-formal-approval/anchor')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalApprovalWorkflowAnchor(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingFormalApprovalWorkflowAnchorResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingFormalApprovalWorkflowAnchorUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingFormalApprovalWorkflowAnchorResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-formal-approval/authority-matrix')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingApprovalAuthorityMatrix(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingApprovalAuthorityMatrixResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingApprovalAuthorityMatrixUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingApprovalAuthorityMatrixResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-formal-approval/evidence-pack')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalApprovalEvidencePack(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingFormalApprovalEvidencePackResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingFormalApprovalEvidencePackUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingFormalApprovalEvidencePackResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-formal-approval/decision-workspace')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingApprovalDecisionWorkspace(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingApprovalDecisionWorkspaceResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingApprovalDecisionWorkspaceUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingApprovalDecisionWorkspaceResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-formal-approval/command-center')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalApprovalCommandCenter(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingFormalApprovalCommandCenterResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingFormalApprovalCommandCenterUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingFormalApprovalCommandCenterResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-formal-approval/closeout')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalApprovalWorkflowCloseout(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingFormalApprovalWorkflowCloseoutResponseDto> {
    try {
      const view =
        await this.requestTenantFullAccountingFormalApprovalWorkflowCloseoutUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
  ...
  @Get(':slug/full-accounting-external-execution-tracking/anchor')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingExternalExecutionTrackingAnchor(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingExternalExecutionTrackingAnchorResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingExternalExecutionTrackingAnchorUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingExternalExecutionTrackingAnchorResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-external-execution-tracking/status-ledger')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingExternalExecutionStatusLedger(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingExternalExecutionStatusLedgerResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingExternalExecutionStatusLedgerUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingExternalExecutionStatusLedgerResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-external-execution-tracking/returned-evidence-validation')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingReturnedEvidenceValidationWorkspace(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingReturnedEvidenceValidationWorkspaceResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingReturnedEvidenceValidationWorkspaceUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingReturnedEvidenceValidationWorkspaceResponseDto(
        view,
      );
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
  ...
  @Get(':slug/full-accounting-external-execution-tracking/observation-queue')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingExternalObservationResolutionQueue(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingExternalObservationResolutionQueueResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingExternalObservationResolutionQueueUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingExternalObservationResolutionQueueResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-external-execution-tracking/command-center')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingExternalExecutionTrackingCommandCenter(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingExternalExecutionTrackingCommandCenterResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingExternalExecutionTrackingCommandCenterUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingExternalExecutionTrackingCommandCenterResponseDto(
        view,
      );
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
  ...
  @Get(':slug/full-accounting-external-execution-tracking/closeout')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingExternalExecutionTrackingCloseout(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingExternalExecutionTrackingCloseoutResponseDto> {
    try {
      const view =
        await this.requestTenantFullAccountingExternalExecutionTrackingCloseoutUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingExternalExecutionTrackingCloseoutResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-external-result-intake/anchor')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingExternalResultIntakeAnchor(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingExternalResultIntakeAnchorResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingExternalResultIntakeAnchorUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingExternalResultIntakeAnchorResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-external-result-intake/returned-artifacts')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingReturnedArtifactRegistry(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingReturnedArtifactRegistryResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingReturnedArtifactRegistryUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingReturnedArtifactRegistryResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-external-result-intake/acceptance-criteria')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingInternalAcceptanceCriteriaWorkspace(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingInternalAcceptanceCriteriaWorkspaceResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingInternalAcceptanceCriteriaWorkspaceUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingInternalAcceptanceCriteriaWorkspaceResponseDto(
        view,
      );
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
  ...
  @Get(':slug/full-accounting-external-result-intake/acceptance-decisions')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingAcceptanceDecisionWorkspace(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingAcceptanceDecisionWorkspaceResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingAcceptanceDecisionWorkspaceUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingAcceptanceDecisionWorkspaceResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-external-result-intake/command-center')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingInternalAcceptanceCommandCenter(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingInternalAcceptanceCommandCenterResponseDto> {
    try {
      const view =
        await this.getTenantFullAccountingInternalAcceptanceCommandCenterUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingInternalAcceptanceCommandCenterResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-external-result-intake/closeout')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingExternalResultIntakeCloseout(
    @Param('slug') tenantSlug: string,
    @Query('period') period = '2026-06',
    @Query('year') year = '2026',
  ): Promise<FullAccountingExternalResultIntakeCloseoutResponseDto> {
    try {
      const view =
        await this.requestTenantFullAccountingExternalResultIntakeCloseoutUseCase.execute(
          { tenantSlug, period, year: Number.parseInt(year, 10) },
        );
      return toFullAccountingExternalResultIntakeCloseoutResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) {
        throw new NotFoundException(error.message);
      }
  ...
  @Get(':slug/full-accounting-formal-record-closeout/anchor')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalRecordCloseoutAnchor(@Param('slug') tenantSlug: string, @Query('period') period = '2026-06', @Query('year') year = '2026'): Promise<FullAccountingFormalRecordCloseoutAnchorResponseDto> {
    try {
      const view = await this.getTenantFullAccountingFormalRecordCloseoutAnchorUseCase.execute({ tenantSlug, period, year: Number.parseInt(year, 10) });
      return toFullAccountingFormalRecordCloseoutAnchorResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) { throw new NotFoundException(error.message); }
      throw error;
    }
  ...
  @Get(':slug/full-accounting-formal-record-closeout/archive-readiness')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingArchiveReadinessWorkspace(@Param('slug') tenantSlug: string, @Query('period') period = '2026-06', @Query('year') year = '2026'): Promise<FullAccountingArchiveReadinessWorkspaceResponseDto> {
    try {
      const view = await this.getTenantFullAccountingArchiveReadinessWorkspaceUseCase.execute({ tenantSlug, period, year: Number.parseInt(year, 10) });
      return toFullAccountingArchiveReadinessWorkspaceResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) { throw new NotFoundException(error.message); }
      throw error;
    }
  ...
  @Get(':slug/full-accounting-formal-record-closeout/evidence-packet')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalCloseoutEvidencePacket(@Param('slug') tenantSlug: string, @Query('period') period = '2026-06', @Query('year') year = '2026'): Promise<FullAccountingFormalCloseoutEvidencePacketResponseDto> {
    try {
      const view = await this.getTenantFullAccountingFormalCloseoutEvidencePacketUseCase.execute({ tenantSlug, period, year: Number.parseInt(year, 10) });
      return toFullAccountingFormalCloseoutEvidencePacketResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) { throw new NotFoundException(error.message); }
      throw error;
    }
  ...
  @Get(':slug/full-accounting-formal-record-closeout/attestation-boundary')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingProfessionalCloseoutAttestationBoundary(@Param('slug') tenantSlug: string, @Query('period') period = '2026-06', @Query('year') year = '2026'): Promise<FullAccountingProfessionalCloseoutAttestationBoundaryResponseDto> {
    try {
      const view = await this.getTenantFullAccountingProfessionalCloseoutAttestationBoundaryUseCase.execute({ tenantSlug, period, year: Number.parseInt(year, 10) });
      return toFullAccountingProfessionalCloseoutAttestationBoundaryResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) { throw new NotFoundException(error.message); }
      throw error;
    }
  ...
  @Get(':slug/full-accounting-formal-record-closeout/command-center')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalRecordCloseoutCommandCenter(@Param('slug') tenantSlug: string, @Query('period') period = '2026-06', @Query('year') year = '2026'): Promise<FullAccountingFormalRecordCloseoutCommandCenterResponseDto> {
    try {
      const view = await this.getTenantFullAccountingFormalRecordCloseoutCommandCenterUseCase.execute({ tenantSlug, period, year: Number.parseInt(year, 10) });
      return toFullAccountingFormalRecordCloseoutCommandCenterResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) { throw new NotFoundException(error.message); }
      throw error;
    }
  ...
  @Get(':slug/full-accounting-formal-record-closeout/closeout')
  @RequireTenantPermission(ACCOUNTING_PERMISSIONS.READ)
  async getFullAccountingFormalRecordCloseoutCloseout(@Param('slug') tenantSlug: string, @Query('period') period = '2026-06', @Query('year') year = '2026'): Promise<FullAccountingFormalRecordCloseoutCloseoutResponseDto> {
    try {
      const view = await this.requestTenantFullAccountingFormalRecordCloseoutCloseoutUseCase.execute({ tenantSlug, period, year: Number.parseInt(year, 10) });
      return toFullAccountingFormalRecordCloseoutCloseoutResponseDto(view);
    } catch (error) {
      if (error instanceof TenantNotFoundError) { throw new NotFoundException(error.message); }
      throw error;
    }

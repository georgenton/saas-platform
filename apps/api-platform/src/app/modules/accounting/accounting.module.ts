...
@Module({
  ...
  providers: [
    ...
    { provide: GetTenantFullAccountingArchiveHandoffAnchorUseCase, inject: [RequestTenantFullAccountingFormalRecordCloseoutCloseoutUseCase], useFactory: (uc) => new GetTenantFullAccountingArchiveHandoffAnchorUseCase(uc) },
    { provide: GetTenantFullAccountingArchiveHandoffPackageUseCase, inject: [GetTenantFullAccountingArchiveHandoffAnchorUseCase], useFactory: (uc) => new GetTenantFullAccountingArchiveHandoffPackageUseCase(uc) },
    { provide: GetTenantFullAccountingOperationalExitSignalMatrixUseCase, inject: [GetTenantFullAccountingArchiveHandoffPackageUseCase], useFactory: (uc) => new GetTenantFullAccountingOperationalExitSignalMatrixUseCase(uc) },
    { provide: GetTenantFullAccountingCustodyDecisionWorkspaceUseCase, inject: [GetTenantFullAccountingOperationalExitSignalMatrixUseCase], useFactory: (uc) => new GetTenantFullAccountingCustodyDecisionWorkspaceUseCase(uc) },
    { provide: GetTenantFullAccountingArchiveHandoffCommandCenterUseCase, inject: [GetTenantFullAccountingCustodyDecisionWorkspaceUseCase], useFactory: (uc) => new GetTenantFullAccountingArchiveHandoffCommandCenterUseCase(uc) },
    { provide: RequestTenantFullAccountingArchiveHandoffCloseoutUseCase, inject: [GetTenantFullAccountingArchiveHandoffCommandCenterUseCase], useFactory: (uc) => new RequestTenantFullAccountingArchiveHandoffCloseoutUseCase(uc) },
    { provide: GetTenantFullAccountingCompletionAnchorUseCase, inject: [RequestTenantFullAccountingArchiveHandoffCloseoutUseCase], useFactory: (uc) => new GetTenantFullAccountingCompletionAnchorUseCase(uc) },
    { provide: GetTenantFullAccountingLifecycleCoverageMatrixUseCase, inject: [GetTenantFullAccountingCompletionAnchorUseCase], useFactory: (uc) => new GetTenantFullAccountingLifecycleCoverageMatrixUseCase(uc) },
    { provide: GetTenantFullAccountingGuardrailCompletionAuditUseCase, inject: [GetTenantFullAccountingLifecycleCoverageMatrixUseCase], useFactory: (uc) => new GetTenantFullAccountingGuardrailCompletionAuditUseCase(uc) },
    { provide: GetTenantFullAccountingContractInventoryUseCase, inject: [GetTenantFullAccountingGuardrailCompletionAuditUseCase], useFactory: (uc) => new GetTenantFullAccountingContractInventoryUseCase(uc) },
    { provide: GetTenantFullAccountingOperationalReadinessUseCase, inject: [GetTenantFullAccountingContractInventoryUseCase], useFactory: (uc) => new GetTenantFullAccountingOperationalReadinessUseCase(uc) },
    { provide: RequestTenantFullAccountingCompletionCloseoutUseCase, inject: [GetTenantFullAccountingOperationalReadinessUseCase], useFactory: (uc) => new RequestTenantFullAccountingCompletionCloseoutUseCase(uc) },
    {

...
export interface EcommerceLaunchPlanResponseDto {
  id: string;
  title: string;
...
export interface EcommerceLaunchWorkspaceResponseDto {
  tenantSlug: string;
  generatedAt: string;
  summary: {
  ...
  launchPlans: EcommerceLaunchPlanResponseDto[];
  launchHints: Array<{
    key: string;
    title: string;
    objective: string;
...
export function toEcommerceLaunchWorkspaceResponseDto(
  ...
  return {
    ...
    launchPlans: view.launchPlans.map((entry) =>
      toEcommerceLaunchPlanResponseDto(entry),
    ),
...
export function toEcommerceLaunchPlanResponseDto(

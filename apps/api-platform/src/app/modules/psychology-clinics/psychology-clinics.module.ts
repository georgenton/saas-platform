...
@Module({
  ...
  providers: [
    ...
    {
      provide: GetTenantPsychologyClinicCommandCenterV60UseCase,
      inject: [
        GetTenantPsychologyClinicProductAnchorUseCase,
        GetTenantPsychologyClinicOperationsCloseoutUseCase,
        GetTenantPsychologyClinicProductReadinessReportUseCase,
      ...
      useFactory: (
        productAnchorUseCase,
        operationsCloseoutUseCase,
        productReadinessReportUseCase,
        closeoutV5UseCase,
        operationsRepository,
      ) =>
        new GetTenantPsychologyClinicCommandCenterV60UseCase(
          productAnchorUseCase,
          operationsCloseoutUseCase,
          productReadinessReportUseCase,
          closeoutV5UseCase,
    ...
    {
      provide: GetTenantPsychologyClinicCrossProductHandoffCenterV60UseCase,
      inject: [
        RequestTenantPsychologyClinicGrowthReminderBridgeUseCase,
        RequestTenantPsychologyClinicBillingTaxBridgeUseCase,
        GetTenantPsychologyClinicProductReadinessReportUseCase,
      ...
      useFactory: (
        growthReminderBridgeUseCase,
        billingTaxBridgeUseCase,
        productReadinessReportUseCase,
        boundaryComplianceCloseoutUseCase,
      ) =>
        new GetTenantPsychologyClinicCrossProductHandoffCenterV60UseCase(
          growthReminderBridgeUseCase,
          billingTaxBridgeUseCase,
          productReadinessReportUseCase,
          boundaryComplianceCloseoutUseCase,
    ...
    {
      provide: RequestTenantPsychologyClinicOperatingCloseoutV60UseCase,
      inject: [
        GetTenantPsychologyClinicCommandCenterV60UseCase,
        GetTenantPsychologyClinicPatientPrivacyRiskQueueV60UseCase,
        GetTenantPsychologyClinicSessionTreatmentQueueV60UseCase,
      ...
      useFactory: (
        ...
        patientPrivacyRiskQueueUseCase,
        sessionTreatmentQueueUseCase,
        handoffCenterUseCase,
        closeoutV5UseCase,
      ) =>
        new RequestTenantPsychologyClinicOperatingCloseoutV60UseCase(
          commandCenterUseCase,
          patientPrivacyRiskQueueUseCase,
          sessionTreatmentQueueUseCase,
          handoffCenterUseCase,

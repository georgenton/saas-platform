...
type Props = {
  ...
  tenantEcommerceOrderPostSaleReportingBoardLoading: boolean;
  tenantEcommerceOrderPostSaleReportingSummaryLoading: boolean;
  ...
  onLoadOrderPostSaleReportingBoard: () => void;
  onLoadOrderPostSaleReportingSummary: () => void;
                        ...
                        <div className={styles.stack}>
                            ...
                            <div className={styles.commercialCard}>
                              ...
                              <div className={styles.inlineActions}>
                                ...
                                <button
                                  ...
                                  onClick={onLoadOrderPaymentDisputeWorkspace}
                                  type="button"
                                >
                                  {tenantEcommerceOrderPaymentDisputeWorkspaceLoading
                                    ? 'Cargando payment dispute...'
                                    : 'Cargar payment dispute'}
                                </button>
                                <button
                                  className={styles.secondaryButton}
                                  disabled={
                                ...
                                >
                                  ...
                                  selectedTenantEcommerceOrderDraftDetail
                                    .orderDraft.id
                                    ? 'Solicitando dispute resolution...'
                                    : 'Solicitar dispute resolution'}
                                </button>
                                <button
                                  className={styles.secondaryButton}
                                  disabled={
                                ...
                                >
                                  ...
                                  selectedTenantEcommerceOrderDraftDetail
                                    .orderDraft.id
                                    ? 'Solicitando fulfillment completion...'
                                    : 'Solicitar fulfillment completion'}
                                </button>
                                <button
                                  className={styles.secondaryButton}
                                  disabled={
                                ...
                                >
                                  ...
                                  selectedTenantEcommerceOrderDraftDetail
                                    .orderDraft.id
                                    ? 'Solicitando delivery confirmation...'
                                    : 'Solicitar delivery confirmation'}
                                </button>
                                <button
                                  className={styles.secondaryButton}
                                  disabled={
                            ...
                            <div className={styles.commercialCard}>
                              <div className={styles.sectionHeading}>
                                <div>
                                  ...
                                  <h4>
                                    {
                                      selectedTenantEcommerceOrderPaymentDisputeWorkspace.summary
                                    }
                                  </h4>
                                </div>
                                <span className={styles.badge}>
                                  {humanizeKey(
                                    selectedTenantEcommerceOrderPaymentDisputeWorkspace.disputeStatus,
                                  )}
                                </span>
                              </div>
                              <small>
                                ...
                                {humanizeKey(
                                  selectedTenantEcommerceOrderPaymentDisputeWorkspace
                                    .disputeProfile.activeChannel,
                                )}{' '}
                                · Owner:{' '}
                                {humanizeKey(
                                  selectedTenantEcommerceOrderPaymentDisputeWorkspace
                                    .disputeProfile.recommendedOwnerRole,
                                )}
                              </small>
                              <small>
                                Expected evidence:{' '}
                                {selectedTenantEcommerceOrderPaymentDisputeWorkspace
                                  .disputeProfile.expectedEvidence.length > 0
                                  ? selectedTenantEcommerceOrderPaymentDisputeWorkspace.disputeProfile.expectedEvidence.join(
                                      ' | ',
                                    )
                                  : 'Ninguna'}
                              </small>
                              <small>
                                Resolution paths:{' '}
                                {selectedTenantEcommerceOrderPaymentDisputeWorkspace.resolutionPaths
                              ...
                              <small>
                                Next step:{' '}
                                {
                                  selectedTenantEcommerceOrderPaymentDisputeWorkspace.nextStep
                                }
                              </small>
                            </div>
                          ) : null}
                            ...
                            <div className={styles.commercialCard}>
                              <div className={styles.sectionHeading}>
                                <div>
                                  ...
                                  <h4>
                                    {
                                      lastEcommerceOrderPaymentDisputeResolutionPacket.summary
                                    }
                                  </h4>
                                </div>
                                <span className={styles.badge}>
                                  {humanizeKey(
                                    lastEcommerceOrderPaymentDisputeResolutionPacket.resolutionDecision,
                                  )}
                                </span>
                              </div>
                              <small>
                                ...
                                {lastEcommerceOrderPaymentDisputeResolutionPacket
                                  ...
                                  ? lastEcommerceOrderPaymentDisputeResolutionPacket.requiredEvidence.join(
                                      ' | ',
                                    )
                                  : 'Ninguna'}
                              </small>
                              <small>
                                Checklist:{' '}
                                {lastEcommerceOrderPaymentDisputeResolutionPacket.resolutionChecklist.join(
                                  ' | ',
                                )}
                              </small>
                              <small>
                                Next step:{' '}
                                {
                                  lastEcommerceOrderPaymentDisputeResolutionPacket.nextStep
                                }
                              </small>
                            </div>
                          ) : null}
                          ...
                          {lastEcommerceOrderFulfillmentCompletionPacket ? (
                            <div className={styles.commercialCard}>
                              <div className={styles.sectionHeading}>
                                <div>
                                  <span className={styles.label}>
                                    Fulfillment completion packet
                                  </span>
                                  <h4>
                                    {
                                      lastEcommerceOrderFulfillmentCompletionPacket.summary
                                    }
                                  </h4>
                                </div>
                                <span className={styles.badge}>
                                  {humanizeKey(
                                    lastEcommerceOrderFulfillmentCompletionPacket.completionStatus,
                                  )}
                                </span>
                              </div>
                              <small>
                                ...
                                {
                                  lastEcommerceOrderFulfillmentCompletionPacket
                                    .deliveryResult.resultLabel
                                }{' '}
                                ·{' '}
                                {humanizeKey(
                                  lastEcommerceOrderFulfillmentCompletionPacket
                                    .deliveryResult.deliveryMode,
                                )}
                              </small>
                              <small>
                                Checklist:{' '}
                                {lastEcommerceOrderFulfillmentCompletionPacket.completionChecklist.join(
                                  ' | ',
                                )}
                              </small>
                              <small>
                                Operator notes:{' '}
                                {lastEcommerceOrderFulfillmentCompletionPacket.operatorNotes.join(
                                  ' | ',
                                )}
                              </small>
                              <small>
                                Next step:{' '}
                                {
                                  lastEcommerceOrderFulfillmentCompletionPacket.nextStep
                                }
                              </small>
                            </div>
                          ) : null}
                          {lastEcommerceOrderFulfillmentDeliveryConfirmationPacket ? (
                            <div className={styles.commercialCard}>
                              <div className={styles.sectionHeading}>
                                <div>
                                  <span className={styles.label}>
                                    Delivery confirmation packet
                                  </span>
                                  <h4>
                                    {
                                      lastEcommerceOrderFulfillmentDeliveryConfirmationPacket.summary
                                    }
                                  </h4>
                                </div>
                                <span className={styles.badge}>
                                  {humanizeKey(
                                    lastEcommerceOrderFulfillmentDeliveryConfirmationPacket.confirmationStatus,
                                  )}
                                </span>
                              </div>
                              <small>
                                ...
                                {
                                  lastEcommerceOrderFulfillmentDeliveryConfirmationPacket
                                    .confirmationRecord.resultLabel
                                }{' '}
                                ·{' '}
                                {humanizeKey(
                                  lastEcommerceOrderFulfillmentDeliveryConfirmationPacket
                                    .confirmationRecord.deliveryChannel,
                                )}
                              </small>
                              <small>
                                Evidence:{' '}
                                {lastEcommerceOrderFulfillmentDeliveryConfirmationPacket.evidenceChecklist.join(
                                  ' | ',
                                )}
                              </small>
                              <small>
                                Operator notes:{' '}
                                {lastEcommerceOrderFulfillmentDeliveryConfirmationPacket.operatorNotes.join(
                                  ' | ',
                                )}
                              </small>
                              <small>
                          ...
                          <div className={styles.inlineActions}>
                            ...
                            <button
                              ...
                              onClick={onLoadOrderPostSaleReportingBoard}
                              type="button"
                            >
                              {tenantEcommerceOrderPostSaleReportingBoardLoading
                                ? 'Cargando post-sale reporting...'
                                : 'Cargar post-sale reporting'}
                            </button>
                            <button
                              className={styles.secondaryButton}
                              disabled={
                              ...
                              onClick={onLoadOrderPostSaleReportingSummary}
                              type="button"
                            >
                              {tenantEcommerceOrderPostSaleReportingSummaryLoading
                                ? 'Cargando reporting summary...'
                                : 'Cargar reporting summary'}
                            </button>
                            <button
                              className={styles.secondaryButton}
                              disabled={
                          ...
                          {tenantEcommerceOrderPostSaleReportingBoard ? (
                            <div className={styles.stack}>
                              ...
                              <small>
                                Reporting lanes:{' '}
                                {tenantEcommerceOrderPostSaleReportingBoard.reportingLanes
                                  .map(
                                    (lane) =>
                                      `${humanizeKey(lane.laneKey)} (${lane.count})`,
                                  )
                              ...
                              {tenantEcommerceOrderPostSaleReportingBoard.entries
                                .length === 0 ? (
                                <small>
                                  Todavía no hay órdenes en el post-sale reporting board.
                                </small>
                              ) : (
                                <ul className={styles.customerList}>
                                  {tenantEcommerceOrderPostSaleReportingBoard.entries.map(
                                    (entry) => (
                                      <li
                                        className={styles.customerListItem}
                                        key={entry.orderDraftId}
                                      >
                                        <div className={styles.customerListPrimary}>
                                          <strong>{entry.orderLabel}</strong>
                                          <small>
                                            {humanizeKey(entry.reportingStatus)} ·{' '}
                                            {humanizeKey(entry.driftSignal)}
                                          </small>
                          ...
                          {tenantEcommerceOrderPostSaleReportingSummary ? (
                            <div className={styles.commercialCard}>
                              ...
                              <small>
                                ...
                                {
                                  tenantEcommerceOrderPostSaleReportingSummary
                                    .revenueSnapshot.confirmedOrderCount
                                }{' '}
                                confirmed ·{' '}
                                {
                                  tenantEcommerceOrderPostSaleReportingSummary
                                    .revenueSnapshot.readyForFulfillmentCount
                                }{' '}
                                ready for fulfillment
                              </small>
                              <small>
                                Highlights:{' '}
                                {tenantEcommerceOrderPostSaleReportingSummary.operationalHighlights.join(
                                  ' | ',
                                )}
                              </small>
                              <small>
                                Next focus:{' '}
                                {
                                  tenantEcommerceOrderPostSaleReportingSummary.nextFocus
                                }
                              </small>
                            </div>
                          ) : null}

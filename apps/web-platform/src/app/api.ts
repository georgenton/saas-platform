...
export async function fetchAccountingAdvancedMvpReadinessCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedMvpReadinessCloseoutResponse> {
  return request<AccountingAdvancedMvpReadinessCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/advanced-mvp-readiness/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchAccountingAdvancedMvpOperatingCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedMvpOperatingCloseoutResponse> {
  return request<AccountingAdvancedMvpOperatingCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
...
export async function fetchAccountingAdvancedGraduationCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedGraduationCloseoutResponse> {
  return request<AccountingAdvancedGraduationCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/advanced-graduation/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchAccountingAdvancedFormalReadinessCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedFormalReadinessCloseoutResponse> {
  return request<AccountingAdvancedFormalReadinessCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/advanced-formal-readiness/certified-bank-reconciliation-closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchAccountingAdvancedFormalProductDesignCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedFormalProductDesignCloseoutResponse> {
  return request<AccountingAdvancedFormalProductDesignCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/advanced-formal-design/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchAccountingAdvancedFormalArtifactDraftingCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedFormalArtifactDraftingCloseoutResponse> {
  return request<AccountingAdvancedFormalArtifactDraftingCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/advanced-formal-drafting/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchAccountingAdvancedProfessionalReviewExecutionCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedProfessionalReviewExecutionCloseoutResponse> {
  return request<AccountingAdvancedProfessionalReviewExecutionCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
...
export async function fetchAccountingAdvancedSignatureCertificationBoundaryCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedSignatureCertificationBoundaryCloseoutResponse> {
  return request<AccountingAdvancedSignatureCertificationBoundaryCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/advanced-signature-certification/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchAccountingAdvancedExternalExecutionHandoffCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedExternalExecutionHandoffCloseoutResponse> {
  return request<AccountingAdvancedExternalExecutionHandoffCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
...
export async function fetchAccountingAdvancedExternalResultIntakeCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedExternalResultIntakeCloseoutResponse> {
  return request<AccountingAdvancedExternalResultIntakeCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/advanced-external-result-intake/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchAccountingAdvancedFormalRecordAssemblyCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedFormalRecordAssemblyCloseoutResponse> {
  return request<AccountingAdvancedFormalRecordAssemblyCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/advanced-formal-record-assembly/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchAccountingAdvancedFormalRecordCloseoutCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<AccountingAdvancedFormalRecordCloseoutCloseoutResponse> {
  return request<AccountingAdvancedFormalRecordCloseoutCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
...
export async function fetchFullAccountingCandidateCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingCandidateCloseoutResponse> {
  return request<FullAccountingCandidateCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-candidate/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingMvpReadinessCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingMvpReadinessCloseoutResponse> {
  return request<FullAccountingMvpReadinessCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
...
export async function fetchFullAccountingControlledPilotCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingControlledPilotCloseoutResponse> {
  return request<FullAccountingControlledPilotCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-controlled-pilot/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingGraduationCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingGraduationCloseoutResponse> {
  return request<FullAccountingGraduationCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-graduation/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingProductDesignCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingProductDesignCloseoutResponse> {
  return request<FullAccountingProductDesignCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-product-design/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingFormalReadinessCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingFormalReadinessCloseoutResponse> {
  return request<FullAccountingFormalReadinessCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-formal-readiness/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingFormalArtifactDraftingCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingFormalArtifactDraftingCloseoutResponse> {
  return request<FullAccountingFormalArtifactDraftingCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-formal-artifact-drafting/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingProfessionalReviewExecutionCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingProfessionalReviewExecutionCloseoutResponse> {
  return request<FullAccountingProfessionalReviewExecutionCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-professional-review-execution/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingFormalApprovalWorkflowCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingFormalApprovalWorkflowCloseoutResponse> {
  return request<FullAccountingFormalApprovalWorkflowCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-formal-approval/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingSignatureCertificationBoundaryCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingSignatureCertificationBoundaryCloseoutResponse> {
  return request<FullAccountingSignatureCertificationBoundaryCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-signature-certification/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingExternalExecutionHandoffCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingExternalExecutionHandoffCloseoutResponse> {
  return request<FullAccountingExternalExecutionHandoffCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-external-execution-handoff/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingExternalExecutionTrackingCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingExternalExecutionTrackingCloseoutResponse> {
  return request<FullAccountingExternalExecutionTrackingCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-external-execution-tracking/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingExternalResultIntakeCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<FullAccountingExternalResultIntakeCloseoutResponse> {
  return request<FullAccountingExternalResultIntakeCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(
      tenantSlug,
    )}/full-accounting-external-result-intake/closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchFullAccountingFormalRecordAssemblyCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
...
export async function fetchFullAccountingArchiveHandoffCloseout(
  token: string, tenantSlug: string, period: string, year: number,
): Promise<FullAccountingArchiveHandoffCloseoutResponse> {
  return request<FullAccountingArchiveHandoffCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(tenantSlug)}/full-accounting-archive-handoff/closeout?period=${encodeURIComponent(period)}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
}

export async function fetchFullAccountingCompletionCloseout(
  token: string, tenantSlug: string, period: string, year: number,
): Promise<FullAccountingCompletionCloseoutResponse> {
  return request<FullAccountingCompletionCloseoutResponse>(
    `/accounting/tenants/${encodeURIComponent(tenantSlug)}/full-accounting-completion-closeout/closeout?period=${encodeURIComponent(period)}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
}
...
export async function fetchEcuadorTaxAccountingEvidenceFromFoundation(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAccountingEvidenceFromFoundationResponse> {
  return request<EcuadorTaxAccountingEvidenceFromFoundationResponse>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/accounting-evidence-from-foundation?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxCommandCenterV2(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxCommandCenterV2Response> {
  return request<EcuadorTaxCommandCenterV2Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/command-center-v2?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxAssistedDeclarationReviewPackV2(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAssistedDeclarationReviewPackV2Response> {
  return request<EcuadorTaxAssistedDeclarationReviewPackV2Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/assisted-declaration-review-pack-v2?period=${encodeURIComponent(
      period,
...
export async function fetchEcuadorTaxAccountingBoundaryCloseout(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAccountingBoundaryCloseoutResponse> {
  return request<EcuadorTaxAccountingBoundaryCloseoutResponse>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/accounting-boundary-closeout?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxSriSourceImportCenterV2(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxSriSourceImportCenterV2Response> {
  return request<EcuadorTaxSriSourceImportCenterV2Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/sri-source-import-center-v2?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxVatDeclarationWorkspaceV2(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxVatDeclarationWorkspaceV2Response> {
  return request<EcuadorTaxVatDeclarationWorkspaceV2Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/vat-declaration-workspace-v2?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxIncomeTaxEvidenceWorkspaceV2(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxIncomeTaxEvidenceWorkspaceV2Response> {
  return request<EcuadorTaxIncomeTaxEvidenceWorkspaceV2Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/income-tax-evidence-workspace-v2?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxFilingAssistantV2(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxFilingAssistantV2Response> {
  return request<EcuadorTaxFilingAssistantV2Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/filing-assistant-v2?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}&formKey=iva`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxAccountantEscalationServiceBoundary(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAccountantEscalationServiceBoundaryResponse> {
  return request<EcuadorTaxAccountantEscalationServiceBoundaryResponse>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/accountant-escalation-service-boundary?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxComplianceCloseoutV2(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxComplianceCloseoutV2Response> {
  return request<EcuadorTaxComplianceCloseoutV2Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
...
export async function fetchEcuadorTaxPilotCohortRegistryV71(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPilotCohortRegistryV71Response> {
  return request<EcuadorTaxPilotCohortRegistryV71Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/pilot-cohort-registry-v71?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxPilotFeedbackAnalyticsDashboardV71(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPilotFeedbackAnalyticsDashboardV71Response> {
  return request<EcuadorTaxPilotFeedbackAnalyticsDashboardV71Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/pilot-feedback-analytics-dashboard-v71?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxAccountantCollaborationSlaTrackerV71(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAccountantCollaborationSlaTrackerV71Response> {
  return request<EcuadorTaxAccountantCollaborationSlaTrackerV71Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/accountant-collaboration-sla-tracker-v71?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxPilotLearningBacklogV71(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPilotLearningBacklogV71Response> {
  return request<EcuadorTaxPilotLearningBacklogV71Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/pilot-learning-backlog-v71?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxAccountingAdvancedEvidenceGateV71(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAccountingAdvancedEvidenceGateV71Response> {
  return request<EcuadorTaxAccountingAdvancedEvidenceGateV71Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/accounting-advanced-evidence-gate-v71?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxPilotOperationsCloseoutV71(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPilotOperationsCloseoutV71Response> {
  return request<EcuadorTaxPilotOperationsCloseoutV71Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/pilot-operations-closeout-v71?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxPilotEvidencePersistenceLedgerV72(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPilotEvidencePersistenceLedgerV72Response> {
  return request<EcuadorTaxPilotEvidencePersistenceLedgerV72Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/pilot-evidence-persistence-ledger-v72?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxPilotMultiTenantCohortV72(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPilotMultiTenantCohortV72Response> {
  return request<EcuadorTaxPilotMultiTenantCohortV72Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/pilot-multi-tenant-cohort-v72?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxPilotRepeatedSignalDetectorV72(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPilotRepeatedSignalDetectorV72Response> {
  return request<EcuadorTaxPilotRepeatedSignalDetectorV72Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/pilot-repeated-signal-detector-v72?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxAccountantCollaborationWorkbenchV72(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAccountantCollaborationWorkbenchV72Response> {
  return request<EcuadorTaxAccountantCollaborationWorkbenchV72Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/accountant-collaboration-workbench-v72?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxAiPilotAssistantPacketV72(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAiPilotAssistantPacketV72Response> {
  return request<EcuadorTaxAiPilotAssistantPacketV72Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/ai-pilot-assistant-packet-v72?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxPilotCloseoutV72(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPilotCloseoutV72Response> {
  return request<EcuadorTaxPilotCloseoutV72Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
...
export async function fetchEcuadorTaxPartyEvidenceBridge(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxPartyEvidenceBridgeResponse> {
  return request<EcuadorTaxPartyEvidenceBridgeResponse>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/party-evidence-bridge?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxSriTaxpayerValidationReadiness(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxSriTaxpayerValidationReadinessResponse> {
  return request<EcuadorTaxSriTaxpayerValidationReadinessResponse>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/sri-taxpayer-validation-readiness?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxDeclarationPartyImpactWorkspace(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxDeclarationPartyImpactWorkspaceResponse> {
  return request<EcuadorTaxDeclarationPartyImpactWorkspaceResponse>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/declaration-party-impact-workspace?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxAssistedFiscalCorrectionFlow(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAssistedFiscalCorrectionFlowResponse> {
  return request<EcuadorTaxAssistedFiscalCorrectionFlowResponse>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/assisted-fiscal-correction-flow?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxAccountantReviewFromPartyRisks(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxAccountantReviewFromPartyRisksResponse> {
  return request<EcuadorTaxAccountantReviewFromPartyRisksResponse>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
    )}/ec/accountant-review-from-party-risks?period=${encodeURIComponent(
      period,
    )}&year=${encodeURIComponent(String(year))}`,
    { method: 'GET', token },
  );
...
export async function fetchEcuadorTaxComplianceHardeningCloseoutV4(
  token: string,
  tenantSlug: string,
  period: string,
  year: number,
): Promise<EcuadorTaxComplianceHardeningCloseoutV4Response> {
  return request<EcuadorTaxComplianceHardeningCloseoutV4Response>(
    `/tax-compliance/tenants/${encodeURIComponent(
      tenantSlug,
...
export async function fetchPsychologyClinicOperationsCloseout(
  token: string,
  tenantSlug: string,
): Promise<PsychologyClinicOperationsCloseoutResponse> {
  return request<PsychologyClinicOperationsCloseoutResponse>(
    `/psychology-clinics/tenants/${encodeURIComponent(
      tenantSlug,
    )}/operations-closeout`,
    {
...
export async function requestPsychologyClinicGrowthReminderBridge(
  token: string,
  tenantSlug: string,
): Promise<PsychologyClinicGrowthReminderBridgeResponse> {
  return request<PsychologyClinicGrowthReminderBridgeResponse>(
    `/psychology-clinics/tenants/${encodeURIComponent(
      tenantSlug,
    )}/growth-reminder-bridge`,
    {
...
export async function requestPsychologyClinicBillingTaxBridge(
  token: string,
  tenantSlug: string,
): Promise<PsychologyClinicBillingTaxBridgeResponse> {
  return request<PsychologyClinicBillingTaxBridgeResponse>(
    `/psychology-clinics/tenants/${encodeURIComponent(
      tenantSlug,
    )}/billing-tax-bridge`,
    {
...
export async function fetchPsychologyClinicTreatmentFollowUpReadiness(
  token: string,
  tenantSlug: string,
  sessionId: string,
): Promise<PsychologyClinicTreatmentFollowUpReadinessResponse> {
  return request<PsychologyClinicTreatmentFollowUpReadinessResponse>(
    `/psychology-clinics/tenants/${encodeURIComponent(
      tenantSlug,
    )}/sessions/${encodeURIComponent(sessionId)}/treatment-follow-up-readiness`,
    {
      method: 'GET',
      token,
    },
...
export async function fetchPsychologyClinicTreatmentPlanWorkspace(
  token: string,
  tenantSlug: string,
  patientId: string,
): Promise<PsychologyClinicTreatmentPlanWorkspaceResponse> {
  return request<PsychologyClinicTreatmentPlanWorkspaceResponse>(
    `/psychology-clinics/tenants/${encodeURIComponent(
      tenantSlug,
    )}/patients/${encodeURIComponent(patientId)}/treatment-plan-workspace`,
    {
      method: 'GET',
      token,
    },
...
export async function fetchPsychologyClinicPatientTimelineWorkspace(
  token: string,
  tenantSlug: string,
  patientId: string,
): Promise<PsychologyClinicPatientTimelineWorkspaceResponse> {
  return request<PsychologyClinicPatientTimelineWorkspaceResponse>(
    `/psychology-clinics/tenants/${encodeURIComponent(
      tenantSlug,

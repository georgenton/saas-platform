...
export interface EcuadorTaxAccountingBridgeMappingResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface AccountingAdvancedFormalApprovalWorkflowCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface AccountingAdvancedSignatureCertificationBoundaryCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface AccountingAdvancedExternalExecutionHandoffCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface AccountingAdvancedGraduationArchiveHandoffCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface FullAccountingMvpOperationsCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  ...
  summary: {
    ...
    readyChecklistCount: number;
    blockedChecklistCount: number;
    operationLaneCount: number;
    ledgerWorkItemCount: number;
    postingDraftCount: number;
    bankWorkItemCount: number;
    trialBalancePreviewItemCount: number;
  };
  blockers: string[];
  nextStep: string;
  guardrails: string[];
...
export interface FullAccountingControlledPilotCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface FullAccountingProfessionalReviewExecutionCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface FullAccountingSignatureCertificationBoundaryCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  ...
  summary: {
    ...
    signatoryCount: number;
    signatureEvidenceItemCount: number;
    certificationRequirementCount: number;
    legalizationItemCount: number;
  };
  blockers: string[];
...
export interface FullAccountingExternalExecutionTrackingCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface FullAccountingFormalRecordCloseoutCloseoutResponse {
  ...
  archiveReadiness: { archiveStatus: string; summary: { folderCount: number; readyFolderCount: number; needsReviewFolderCount: number; blockedFolderCount: number; retainedEvidenceRefCount: number; }; };
  evidencePacket: { packetStatus: string; summary: { packetCount: number; readyPacketCount: number; needsReviewPacketCount: number; blockedPacketCount: number; missingRefCount: number; }; };
  attestationBoundary: { boundaryStatus: string; summary: { itemCount: number; readyItemCount: number; professionalOwnedItemCount: number; platformBoundaryItemCount: number; }; };
  commandCenter: { commandStatus: string; suggestedDecision: string; summary: { laneCount: number; readyLaneCount: number; needsReviewLaneCount: number; blockedLaneCount: number; archiveReadyCount: number; professionalBoundaryCount: number; }; };
  closeoutChecklist: Array<{ key: string; label: string; status: string; evidenceRefs: string[]; }>;
  finalDecision: string; summary: { checklistCount: number; readyChecklistCount: number; blockedChecklistCount: number; archiveFolderCount: number; evidencePacketCount: number; attestationItemCount: number; };
  blockers: string[]; nextStep: string; guardrails: string[];
}

export interface FullAccountingFormalRecordAssemblyCloseoutResponse {
  tenantSlug: string; period: string; year: number; generatedAt: string; closeoutStatus: string;
  assemblyAnchor: { assemblyStatus: string; summary: { gateCount: number; readyGateCount: number; needsReviewGateCount: number; blockedGateCount: number; acceptedDecisionCount: number; }; };
  artifactBinder: { binderStatus: string; summary: { binderCount: number; readyBinderCount: number; needsReviewBinderCount: number; blockedBinderCount: number; acceptedArtifactRefCount: number; }; };
  recordIndex: { indexStatus: string; summary: { sectionCount: number; readySectionCount: number; needsReviewSectionCount: number; blockedSectionCount: number; binderCount: number; }; };
  consistencyReview: { reviewStatus: string; summary: { checkCount: number; readyCheckCount: number; needsReviewCheckCount: number; blockedCheckCount: number; routedCheckCount: number; }; };
  commandCenter: { commandStatus: string; suggestedDecision: string; summary: { laneCount: number; readyLaneCount: number; needsReviewLaneCount: number; blockedLaneCount: number; assembledRecordCount: number; inconsistentRecordCount: number; readyForCloseoutCount: number; }; };
  closeoutChecklist: Array<{ key: string; label: string; status: string; evidenceRefs: string[]; }>;
  finalDecision: string;
...
export interface FullAccountingExternalResultIntakeCloseoutResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxSriFiscalEvidenceWorkspaceResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  ...
  voucherRows: EcuadorTaxSriVoucherEvidenceResponse[];
  blockers: string[];
  reviewNotes: string[];
  nextStep: string;
  guardrails: string[];
...
export interface RecordEcuadorTaxSriFiscalEvidenceImportRequest {
  period: string;
  year: number;
  source?: string;
  importedByUserId?: string | null;
...
export interface EcuadorTaxSriPlatformReconciliationWorkspaceResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  readinessStatus: string;
  sriEvidenceSummary: EcuadorTaxSriFiscalEvidenceWorkspaceResponse['summary'];
  platformSummary: {
    salesDocuments: number;
    purchaseDocuments: number;
...
export interface EcuadorTaxDeclarationFormCatalogResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxDeclarationSourceLedgerResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxVatDeclarationDraftWorkspaceResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  ...
  formDraftPacket: EcuadorTaxDeclarationFormDraftPacketResponse;
  vatBuckets: Array<{
    bucketKey: string;
    label: string;
    amountInCents: number;
  ...
  suggestedFormBoxes: EcuadorTaxDeclarationFormDraftPacketResponse['suggestedBoxes'];
  summary: {
    bucketCount: number;
...
export interface EcuadorTaxFormMappingCatalogResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxIncomeTaxEvidenceWorkspaceResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  readinessStatus: string;
  sourceLedger: EcuadorTaxDeclarationSourceLedgerResponse;
  evidencePacket: EcuadorTaxIncomeTaxEvidencePacketResponse;
  classifications: Array<{
    key: string;
    label: string;
    amountInCents: number;
...
export interface EcuadorTaxAiFilingAssistantPacketResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxDeclarationReviewLoopWorkspaceResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  loopStatus: string;
  latestAccountantReview: EcuadorTaxAccountantReviewResponse | null;
  filingHandoff: EcuadorTaxFilingHandoffResponse;
  sourceLedger: EcuadorTaxDeclarationSourceLedgerResponse;
  reviewChecklist: Array<{
    key: string;
    label: string;
...
export interface EcuadorTaxPilotTenantReadinessRoomV70Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  readinessStatus: string;
  readinessSections: Array<{
    key: string;
    label: string;
    status: string;
    owner: string;
...
export interface EcuadorTaxAccountantFeedbackIntakeQueueV70Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxEvidenceCorrectionWorkbenchV70Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxPilotCloseoutDecisionPacketV70Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxPilotFeedbackCloseoutV70Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxPilotCohortRegistryV71Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxPilotFeedbackAnalyticsDashboardV71Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxAccountantCollaborationSlaTrackerV71Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxPilotLearningBacklogV71Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxAccountingAdvancedEvidenceGateV71Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxPilotOperationsCloseoutV71Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxPartyRiskRowResponse {
  partyId: string;
  displayName: string;
  roles: string[];
...
export interface EcuadorTaxPartyEvidenceBridgeResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  ...
  impactedParties: EcuadorTaxPartyRiskRowResponse[];
  summary: {
    totalParties: number;
...
export interface EcuadorTaxSriTaxpayerValidationReadinessResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxDeclarationPartyImpactWorkspaceResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  ...
  partyRiskRows: EcuadorTaxPartyRiskRowResponse[];
  summary: {
...
export interface EcuadorTaxAssistedFiscalCorrectionFlowResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  ...
  auditTrail: Array<{ eventKey: string; source: string; detail: string }>;
  summary: {
    candidateCount: number;
...
export interface EcuadorTaxAccountantReviewFromPartyRisksResponse {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
...
export interface EcuadorTaxComplianceHardeningCloseoutV4Response {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: string;
  closeoutStatus: string;
  partyEvidenceBridge: EcuadorTaxPartyEvidenceBridgeResponse;
  taxpayerValidationReadiness: EcuadorTaxSriTaxpayerValidationReadinessResponse;
  declarationPartyImpact: EcuadorTaxDeclarationPartyImpactWorkspaceResponse;
  assistedFiscalCorrectionFlow: EcuadorTaxAssistedFiscalCorrectionFlowResponse;
  accountantReviewFromPartyRisks: EcuadorTaxAccountantReviewFromPartyRisksResponse;
  productCloseoutV3: EcuadorTaxComplianceProductCloseoutV3Response;
...
export interface EcommerceOrderPaymentConfirmationDecisionResponse {
  tenantSlug: string;
  generatedAt: string;
  productEntity: EcommerceProductEntityResponse;
  orderDraft: EcommerceOrderDraftResponse;
...
export interface EcommerceOrderPaymentConfirmationLogResponse {
  tenantSlug: string;
  generatedAt: string;
  productEntity: EcommerceProductEntityResponse;
  orderDraft: EcommerceOrderDraftResponse;
...
export interface EcommerceOrderFulfillmentDeliveryWorkspaceResponse {
  tenantSlug: string;
  generatedAt: string;
  productEntity: EcommerceProductEntityResponse;
  orderDraft: EcommerceOrderDraftResponse;
...
export interface EcommerceOrderRevenueOpsBoardEntryResponse {
  orderDraftId: string;
  orderLabel: string;
...
export interface EcommerceOrderRevenueOpsBoardResponse {
  tenantSlug: string;
  generatedAt: string;
  productEntity: EcommerceProductEntityResponse;
  summary: {
  ...
  entries: EcommerceOrderRevenueOpsBoardEntryResponse[];
}
...
export interface EcommerceOrderPostSaleOpsBoardResponse {
  tenantSlug: string;
  generatedAt: string;
  productEntity: EcommerceProductEntityResponse;
  summary: {
...
export interface MedicalClinicPatientClinicalTimelineWorkspaceResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
  workspaceStatus: MedicalClinicReadinessStatus;
...
export interface MedicalClinicMedicalHistoryDraftRecordResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
...
export interface MedicalClinicClinicalEvidenceRegistryResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
...
export interface MedicalClinicOrdersReferralReadinessPacketResponse {
  tenantSlug: string;
  appointmentId: string;
  generatedAt: string;
  packetStatus: MedicalClinicReadinessStatus;
...
export interface MedicalClinicCarePlanTaskWorkspaceResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
  workspaceStatus: MedicalClinicReadinessStatus;
...
export interface MedicalClinicRecordsCloseoutResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
  closeoutStatus: MedicalClinicReadinessStatus;
...
export interface PsychologyClinicProductAnchorResponse {
  tenantSlug: string;
  generatedAt: string;
...
export interface PsychologyClinicProfileWorkspaceResponse {
  tenantSlug: string;
  generatedAt: string;
...
export interface PsychologyClinicPatientIntakeWorkspaceResponse {
  tenantSlug: string;
  generatedAt: string;
  workspaceStatus: PsychologyClinicReadinessStatus;
  intakeQueue: Array<{
...
export interface PsychologyClinicPatientRecordResponse {
  id: string;
  tenantSlug: string;
  patientDisplayName: string;
...
export interface PsychologyClinicSessionSchedulingWorkspaceResponse {
  tenantSlug: string;
  generatedAt: string;
  workspaceStatus: PsychologyClinicReadinessStatus;
  sessions: Array<{
    ...
    modality: PsychologyClinicSessionRecordResponse['modality'];
    startsAt: string;
...
export interface PsychologyClinicSessionRecordResponse {
  id: string;
  tenantSlug: string;
  patientId: string;
  patientDisplayName: string;
...
export interface PsychologyClinicSessionNoteDraftPacketResponse {
  tenantSlug: string;
  sessionId: string;
  generatedAt: string;
...
export interface PsychologyClinicFoundationCloseoutResponse {
  tenantSlug: string;
  generatedAt: string;
...
export interface PsychologyClinicTreatmentPlanWorkspaceResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
  workspaceStatus: PsychologyClinicReadinessStatus;
...
export interface PsychologyClinicTreatmentFollowUpReadinessResponse {
  tenantSlug: string;
  sessionId: string;
  patientId: string;
  generatedAt: string;
...
export interface PsychologyClinicGrowthReminderBridgeResponse {
  tenantSlug: string;
  generatedAt: string;
...
export interface PsychologyClinicBillingTaxBridgeResponse {
  tenantSlug: string;
  generatedAt: string;
  bridgeStatus: PsychologyClinicReadinessStatus;
  invoiceableItems: Array<{
...
export interface PsychologyClinicPatientTimelineWorkspaceResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
  workspaceStatus: PsychologyClinicReadinessStatus;
...
export interface PsychologyClinicOperationsCloseoutResponse {
  tenantSlug: string;
  generatedAt: string;
  closeoutStatus: PsychologyClinicReadinessStatus;
  closedLayers: Array<{
...
export interface PsychologyClinicEhrDiscoveryWorkspaceResponse {
  tenantSlug: string;
  generatedAt: string;
  workspaceStatus: PsychologyClinicReadinessStatus;
...
export interface PsychologyClinicFormalRecordSignatureReadinessResponse {
  tenantSlug: string;
  generatedAt: string;
  readinessStatus: PsychologyClinicReadinessStatus;
...
export interface PsychologyClinicOutcomesReviewWorkspaceResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
  workspaceStatus: PsychologyClinicReadinessStatus;
...
export interface PsychologyClinicAssessmentScaleRegistryResponse {
  tenantSlug: string;
  patientId: string;
  generatedAt: string;
  registryStatus: PsychologyClinicReadinessStatus;
...
export interface PsychologyClinicExternalDocumentHandoffContractsResponse {
  tenantSlug: string;
  generatedAt: string;
...
export interface PsychologyClinicCloseoutV4Response {
  tenantSlug: string;
  generatedAt: string;
  closeoutStatus: PsychologyClinicReadinessStatus;
  checklist: Array<{
...
export interface RegisterPsychologyClinicPatientIntakeRequest {
  patientDisplayName: string;
  identificationStatus?: PsychologyClinicReadinessStatus;
  contactStatus?: PsychologyClinicReadinessStatus;
  therapyConsentStatus?: PsychologyClinicReadinessStatus;
  ...
  initialRiskReviewStatus?: PsychologyClinicReadinessStatus;
  presentingConcern: string;
  contact?: Partial<PsychologyClinicPatientRecordResponse['contact']>;
  emergencyContact?: Partial<
    PsychologyClinicPatientRecordResponse['emergencyContact']
  >;
  blockers?: string[];
}

export interface CreatePsychologyClinicSessionRequest {
  patientId: string;
  serviceName: string;
  therapistId: string;
  therapistName: string;
...
export interface TransitionPsychologyClinicSessionRequest {
  status: PsychologyClinicSessionStatus;
  blockers?: string[];
}

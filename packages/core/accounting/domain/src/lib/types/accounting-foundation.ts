...
export type FullAccountingProfessionalReviewExecutionDecision =
  ...
  | 'return_to_formal_readiness'
  | 'do_not_advance_formal_artifacts';
export type FullAccountingFormalApprovalWorkflowDecision =
  | 'open_signature_certification_boundary'
  | 'continue_formal_approval'
  | 'return_to_professional_review'
  | 'return_to_artifact_drafting'
  | 'do_not_approve_formal_artifacts';
export type FullAccountingSignatureCertificationBoundaryDecision =
  | 'open_external_execution_handoff'
  | 'continue_signature_certification_boundary'
  | 'return_to_formal_approval'
  | 'return_to_professional_review'
  | 'do_not_prepare_external_execution';
export type FullAccountingExternalExecutionHandoffDecision =
  | 'open_external_execution_tracking'
  | 'continue_external_execution_handoff'
  | 'return_to_signature_certification_boundary'
  | 'return_to_formal_approval'
  | 'do_not_handoff_external_execution';
export type FullAccountingExternalExecutionTrackingDecision =
  | 'open_external_result_intake'
  | 'continue_external_execution_tracking'
  | 'resolve_external_observations'
...
export type FullAccountingFormalRecordAssemblyDecision =
  ...
  | 'return_to_external_execution_tracking'
  | 'do_not_assemble_formal_record';
export type FullAccountingFormalRecordCloseoutDecision =
  | 'open_archive_handoff'
  | 'continue_professional_attestation'
...
export interface TenantFullAccountingFormalApprovalWorkflowAnchorView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  anchorStatus: AccountingReadinessStatus;
  professionalReviewCloseout: TenantFullAccountingProfessionalReviewExecutionCloseoutView;
  approvalGates: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingApprovalAuthorityMatrixView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  matrixStatus: AccountingReadinessStatus;
  approvalAnchor: TenantFullAccountingFormalApprovalWorkflowAnchorView;
  authorities: Array<{
    key: string;
    label: string;
    artifactType:
...
export interface TenantFullAccountingFormalApprovalEvidencePackView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  packStatus: AccountingReadinessStatus;
  authorityMatrix: TenantFullAccountingApprovalAuthorityMatrixView;
  evidenceItems: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingApprovalDecisionWorkspaceView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  workspaceStatus: AccountingReadinessStatus;
  evidencePack: TenantFullAccountingFormalApprovalEvidencePackView;
  decisions: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingFormalApprovalCommandCenterView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
...
export interface TenantFullAccountingFormalApprovalWorkflowCloseoutView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  finalDecision: FullAccountingFormalApprovalWorkflowDecision;
  summary: {
    checklistCount: number;
    readyChecklistCount: number;
    blockedChecklistCount: number;
...
export interface TenantFullAccountingSignatureCertificationBoundaryAnchorView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  anchorStatus: AccountingReadinessStatus;
  formalApprovalCloseout: TenantFullAccountingFormalApprovalWorkflowCloseoutView;
  boundaryGates: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingFormalSignatoryRegistryView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  registryStatus: AccountingReadinessStatus;
  boundaryAnchor: TenantFullAccountingSignatureCertificationBoundaryAnchorView;
  signatories: Array<{
    key: string;
    label: string;
    artifactType:
...
export interface TenantFullAccountingSignatureEvidenceReadinessPackView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
...
export interface TenantFullAccountingCertificationRequirementWorkspaceView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  requirements: Array<{
    ...
    label: string;
    status: AccountingReadinessStatus;
    artifactType: 'bank_evidence' | 'financial_statement' | 'trial_balance' | 'professional_boundary';
...
export interface TenantFullAccountingLegalizationBoundaryPacketView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  legalizationItems: Array<{
    ...
    label: string;
    status: AccountingReadinessStatus;
    artifactType: 'ledger_draft' | 'posting_approval' | 'financial_statement' | 'professional_boundary';
    requiredOwner: AccountingAdvancedProfessionalOwner;
    legalizationBoundary: string;
    evidenceRefs: string[];
  }>;
...
export interface TenantFullAccountingSignatureCertificationBoundaryCloseoutView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  finalDecision: FullAccountingSignatureCertificationBoundaryDecision;
  summary: {
    checklistCount: number;
    readyChecklistCount: number;
    blockedChecklistCount: number;
...
export interface TenantFullAccountingExternalExecutionHandoffAnchorView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  anchorStatus: AccountingReadinessStatus;
  signatureCertificationCloseout: TenantFullAccountingSignatureCertificationBoundaryCloseoutView;
  handoffGates: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingExternalExecutorAssignmentMatrixView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  matrixStatus: AccountingReadinessStatus;
  handoffAnchor: TenantFullAccountingExternalExecutionHandoffAnchorView;
  assignments: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingExecutionHandoffEvidenceBundleView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
...
export interface TenantFullAccountingExternalExecutionInstructionPackView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
...
export interface TenantFullAccountingExecutionReturnEvidenceIntakeView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  intakeStatus: AccountingReadinessStatus;
  instructionPack: TenantFullAccountingExternalExecutionInstructionPackView;
  returnChannels: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingExternalExecutionHandoffCloseoutView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  finalDecision: FullAccountingExternalExecutionHandoffDecision;
  summary: {
    checklistCount: number;
    readyChecklistCount: number;
    blockedChecklistCount: number;
...
export interface TenantFullAccountingExternalExecutionTrackingAnchorView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  trackingStatus: AccountingReadinessStatus;
  handoffCloseout: TenantFullAccountingExternalExecutionHandoffCloseoutView;
  trackingLanes: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingExternalExecutionStatusLedgerView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ledgerStatus: AccountingReadinessStatus;
  trackingAnchor: TenantFullAccountingExternalExecutionTrackingAnchorView;
  events: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingReturnedEvidenceValidationWorkspaceView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  validationStatus: AccountingReadinessStatus;
  statusLedger: TenantFullAccountingExternalExecutionStatusLedgerView;
  validations: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
...
export interface TenantFullAccountingExternalObservationResolutionQueueView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
...
export interface TenantFullAccountingExternalExecutionTrackingCommandCenterView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  suggestedDecision: FullAccountingExternalExecutionTrackingDecision;
  summary: {
    laneCount: number;
    readyLaneCount: number;
    needsReviewLaneCount: number;
...
export interface TenantFullAccountingExternalExecutionTrackingCloseoutView {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  validationWorkspace: TenantFullAccountingReturnedEvidenceValidationWorkspaceView;
  observationQueue: TenantFullAccountingExternalObservationResolutionQueueView;
  commandCenter: TenantFullAccountingExternalExecutionTrackingCommandCenterView;
  closeoutChecklist: Array<{
    key: string;
    label: string;
    status: AccountingReadinessStatus;
  ...
  finalDecision: FullAccountingExternalExecutionTrackingDecision;
  summary: {
    checklistCount: number;
    readyChecklistCount: number;
    blockedChecklistCount: number;
...
export interface TenantFullAccountingFormalRecordCloseoutAnchorView {
  tenantSlug: string; period: string; year: number; generatedAt: Date; anchorStatus: AccountingReadinessStatus;
  assemblyCloseout: TenantFullAccountingFormalRecordAssemblyCloseoutView;
  closeoutGates: Array<{ key: string; label: string; status: AccountingReadinessStatus; gateType: 'assembly_package' | 'record_index' | 'consistency_review' | 'command_decision' | 'closeout_checklist'; closeoutState: 'ready_for_archive_readiness' | 'needs_review' | 'returned_to_assembly' | 'blocked'; evidenceRefs: string[]; }>;
  summary: { gateCount: number; readyGateCount: number; needsReviewGateCount: number; blockedGateCount: number; assemblyChecklistCount: number; };
  blockers: string[]; nextStep: string; guardrails: string[];
}

export interface TenantFullAccountingArchiveReadinessWorkspaceView {
  tenantSlug: string; period: string; year: number; generatedAt: Date; archiveStatus: AccountingReadinessStatus;
  closeoutAnchor: TenantFullAccountingFormalRecordCloseoutAnchorView;
  archiveFolders: Array<{ key: string; label: string; status: AccountingReadinessStatus; folderType: 'formal_record_package' | 'evidence_chain' | 'decision_log' | 'professional_review' | 'exceptions'; retentionSignal: 'retain_for_period_closeout' | 'retain_for_professional_review' | 'retain_as_exception' | 'do_not_archive_yet'; evidenceRefs: string[]; blockerRefs: string[]; }>;
  summary: { folderCount: number; readyFolderCount: number; needsReviewFolderCount: number; blockedFolderCount: number; retainedEvidenceRefCount: number; };
  blockers: string[]; nextStep: string; guardrails: string[];
}

export interface TenantFullAccountingFormalCloseoutEvidencePacketView {
  tenantSlug: string; period: string; year: number; generatedAt: Date; packetStatus: AccountingReadinessStatus;
  archiveReadiness: TenantFullAccountingArchiveReadinessWorkspaceView;
  evidencePackets: Array<{ key: string; label: string; status: AccountingReadinessStatus; archiveFolderKey: string; packetType: 'source_artifacts' | 'index_snapshot' | 'consistency_snapshot' | 'operator_decision' | 'professional_boundary'; evidenceRefs: string[]; missingRefs: string[]; }>;
  summary: { packetCount: number; readyPacketCount: number; needsReviewPacketCount: number; blockedPacketCount: number; missingRefCount: number; };
  blockers: string[]; nextStep: string; guardrails: string[];
}

export interface TenantFullAccountingProfessionalCloseoutAttestationBoundaryView {
  tenantSlug: string; period: string; year: number; generatedAt: Date; boundaryStatus: AccountingReadinessStatus;
  evidencePacket: TenantFullAccountingFormalCloseoutEvidencePacketView;
  attestationItems: Array<{ key: string; label: string; status: AccountingReadinessStatus; owner: AccountingAdvancedProfessionalOwner; attestationType: 'platform_preparation' | 'operator_review' | 'external_accountant_review' | 'legal_representative_acknowledgement' | 'not_certified_by_platform'; evidenceRefs: string[]; guardrail: string; }>;
  summary: { itemCount: number; readyItemCount: number; professionalOwnedItemCount: number; platformBoundaryItemCount: number; };
  blockers: string[]; nextStep: string; guardrails: string[];
}

export interface TenantFullAccountingFormalRecordCloseoutCommandCenterView {
  tenantSlug: string; period: string; year: number; generatedAt: Date; commandStatus: AccountingReadinessStatus;
  attestationBoundary: TenantFullAccountingProfessionalCloseoutAttestationBoundaryView;
  commandLanes: Array<{ key: string; label: string; status: AccountingReadinessStatus; metric: string; count: number; }>;
  suggestedDecision: FullAccountingFormalRecordCloseoutDecision;
  summary: { laneCount: number; readyLaneCount: number; needsReviewLaneCount: number; blockedLaneCount: number; archiveReadyCount: number; professionalBoundaryCount: number; };
  blockers: string[]; nextStep: string; guardrails: string[];
}

export interface TenantFullAccountingFormalRecordCloseoutCloseoutView {
  tenantSlug: string; period: string; year: number; generatedAt: Date; closeoutStatus: AccountingReadinessStatus;
  closeoutAnchor: TenantFullAccountingFormalRecordCloseoutAnchorView;
  archiveReadiness: TenantFullAccountingArchiveReadinessWorkspaceView;
  evidencePacket: TenantFullAccountingFormalCloseoutEvidencePacketView;
  attestationBoundary: TenantFullAccountingProfessionalCloseoutAttestationBoundaryView;
  commandCenter: TenantFullAccountingFormalRecordCloseoutCommandCenterView;
  closeoutChecklist: Array<{ key: string; label: string; status: AccountingReadinessStatus; evidenceRefs: string[]; }>;

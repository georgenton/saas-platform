...
export type EcuadorTaxComplianceEventType =
  ...
  | 'tax_pilot_decision_closeout_v73_requested';
...
export interface EcuadorTaxPilotTenantReadinessRoomV70View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  readinessStatus: EcuadorTaxReadinessStatus;
  operationalCloseout: EcuadorTaxOperationalHardeningCloseoutV62View;
...
export interface EcuadorTaxAccountantFeedbackIntakeQueueV70View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
...
export interface EcuadorTaxEvidenceCorrectionWorkbenchV70View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  correctionActions: Array<{
    ...
    correctionType:
      ...
      | 'reconcile_sri_platform'
      | 'update_form_box_hint'
      | 'mark_not_applicable'
      | 'route_to_accountant';
    owner: 'operator' | 'accountant' | 'tax_compliance';
    evidenceRefs: string[];
...
export interface EcuadorTaxPilotCloseoutDecisionPacketV70View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  packetStatus: EcuadorTaxReadinessStatus;
  readinessRoom: EcuadorTaxPilotTenantReadinessRoomV70View;
  feedbackQueue: EcuadorTaxAccountantFeedbackIntakeQueueV70View;
  correctionWorkbench: EcuadorTaxEvidenceCorrectionWorkbenchV70View;
  decisionLanes: Array<{
    key: string;
    label: string;
    status: EcuadorTaxReadinessStatus;
    owner: 'operator' | 'accountant' | 'tax_compliance' | 'accounting_advanced';
    evidenceRefs: string[];
    action: string;
  }>;
  decision: {
...
export interface EcuadorTaxPilotFeedbackCloseoutV70View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  feedbackQueue: EcuadorTaxAccountantFeedbackIntakeQueueV70View;
  correctionWorkbench: EcuadorTaxEvidenceCorrectionWorkbenchV70View;
  decisionPacket: EcuadorTaxPilotCloseoutDecisionPacketV70View;
  closeoutChecklist: Array<{
    key: string;
    label: string;
    status: EcuadorTaxReadinessStatus;
...
export interface EcuadorTaxPilotPeriodOverPeriodMemoryV73View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  memoryStatus: EcuadorTaxReadinessStatus;
  pilotCloseout: EcuadorTaxPilotCloseoutV72View;
  memoryRows: Array<{
    key: string;
    label: string;
    status: EcuadorTaxReadinessStatus;
    previousPeriodStatus: EcuadorTaxReadinessStatus | null;
    movement: 'new' | 'resolved' | 'repeated' | 'worsened' | 'stable';
    owner: 'operator' | 'accountant' | 'tax_compliance' | 'ai';
    evidenceRefs: string[];
    recommendation: string;
  }>;
  summary: {
...
export interface EcuadorTaxAccountingAdvancedDiscoveryDossierV73View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  dossierStatus: EcuadorTaxReadinessStatus;
  periodMemory: EcuadorTaxPilotPeriodOverPeriodMemoryV73View;
  ...
  recommendation: {
    ...
    discoveryScope:
      | 'none'
      | 'accounting_boundary_review'
      | 'bank_reconciliation_discovery'
...
export interface EcuadorTaxAccountantDecisionRecordV73View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  recordStatus: EcuadorTaxReadinessStatus;
  discoveryDossier: EcuadorTaxAccountingAdvancedDiscoveryDossierV73View;
  decisions: Array<{
    key: string;
    label: string;
    status: EcuadorTaxReadinessStatus;
    decision:
      ...
      | 'needs_more_evidence';
    decidedBy: 'external_accountant' | 'tax_operator';
    rationale: string;
    evidenceRefs: string[];
    nextAction: string;
  }>;
...
export interface EcuadorTaxPilotCohortExpansionReadinessV73View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  readinessStatus: EcuadorTaxReadinessStatus;
  accountantDecisionRecord: EcuadorTaxAccountantDecisionRecordV73View;
...
export interface EcuadorTaxAiPilotDecisionExplainerV73View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  explainerStatus: EcuadorTaxReadinessStatus;
  expansionReadiness: EcuadorTaxPilotCohortExpansionReadinessV73View;
  explanationCards: Array<{
    key: string;
    label: string;
    status: EcuadorTaxReadinessStatus;
    audience: 'operator' | 'accountant' | 'founder';
    promptPackVersion: string;
    contextRefs: string[];
    explanation: string;
    guardrail: string;
...
export interface EcuadorTaxPilotDecisionCloseoutV73View {
  tenantSlug: string;
  period: string;
  year: number;
  generatedAt: Date;
  ...
  accountantDecisionRecord: EcuadorTaxAccountantDecisionRecordV73View;
  expansionReadiness: EcuadorTaxPilotCohortExpansionReadinessV73View;
  aiDecisionExplainer: EcuadorTaxAiPilotDecisionExplainerV73View;
  closeoutChecklist: Array<{
    key: string;
    label: string;
    status: EcuadorTaxReadinessStatus;
